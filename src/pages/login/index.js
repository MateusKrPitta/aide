...
const LoginPage = () => {
    ...
    const handleLogin = () => {
        setLoading(true);
        // Aqui você normalmente faria uma chamada API para autenticação
        // Simulando uma autenticação com setTimeout
        setTimeout(() => {
            setLoading(false);
    ...
    return (
        <div className='login-container'>
            <div className="login-container flex h-screen items-center justify-center ">
                <div className="relative p-8 rounded-lg shadow-lg max-w-md w-full z-10" style={{ border: '1px solid #9D4B5B', backgroundColor:'white' }}>
                    <div className="flex justify-center mb-10" >
                        <img src={Logo} alt="Logo Pax Verde" className="w-22" style={{ borderRadius: "10px", width: '30%' }} />
                    </div>
                    ...
                    <button
                        onClick={handleLogin}
                        disabled={loading}
                        style={{ backgroundColor: '#9D4B5B', color: 'white', fontWeight: '600' }}
