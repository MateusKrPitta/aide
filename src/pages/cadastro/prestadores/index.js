...
import { Article, Close, Edit, Numbers, Person, Phone, Work, } from '@mui/icons-material';
import { Autocomplete, Box, Chip, FormControl, InputAdornment, InputLabel, MenuItem, Select, TextField } from '@mui/material';
...
const Prestadores = () => {
    ...
    const [listaServicos, setListaServicos] = useState([
        {
            ...
            descricao: "Serviço completo de manutenção preventiva e corretiva para computadores"
        },
        {
            id: 2,
        ...
        },
        {
            ...
            descricao: "Análise e recomendação de soluções tecnológicas para empresas"
        },
        {
            id: 4,
        ...
        },
        {
            ...
            descricao: "Atendimento remoto e presencial para resolução de problemas técnicos"
        }
    ]);
                            ...
                            <div className='w-full'>
                                {loading ? (
                                    ...
                                    <div className="text-center flex items-center mt-28 justify-center gap-5 flex-col text-primary">
                                        <TableLoading />
                                        <label className="text-sm">Serviço não encontrado!</label></div>
                                )}
                            </div>
  ...
  value={todosServicos.filter(servico => servicosSelecionados.includes(servico.id))}
  onChange={(event, newValue) => {
    setServicosSelecionados(newValue.map(item => item.id));
  }}
